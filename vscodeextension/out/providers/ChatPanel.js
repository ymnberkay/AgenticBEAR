...
class ChatPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('agenticbear.chat', 'AgenticBEAR', vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
    ...
    constructor(panel) {
        ...
        this._panel.webview.onDidReceiveMessage(msg => {
            if (msg.type === 'userMessage') {
                this._onUserMessage?.(msg.text, msg.agentId);
            }
