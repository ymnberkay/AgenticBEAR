    ...
    <div>
      <button
        ...
        className={cn(
          ...
          isSelected && 'bg-[#7c8cf8]/10 text-[#7c8cf8]',
      ...
      >
        ...
        {isDir ? (
          expanded ? (
            <FolderOpen className="h-3.5 w-3.5 text-[#7c8cf8]/70 shrink-0" />
          ) : (
        ...
        {isChanged && (
          <span className="ml-auto h-1.5 w-1.5 rounded-full bg-[#7c8cf8] shrink-0" />
        )}
      </button>
