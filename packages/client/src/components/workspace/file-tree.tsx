    ...
    <div>
      <button
        ...
        className={cn(
          ...
          isSelected && 'bg-[#6EACDA]/10 text-[#6EACDA]',
      ...
      >
        ...
        {isDir ? (
          expanded ? (
            <FolderOpen className="h-3.5 w-3.5 text-[#6EACDA]/70 shrink-0" />
          ) : (
        ...
        {isChanged && (
          <span className="ml-auto h-1.5 w-1.5 rounded-full bg-[#6EACDA] shrink-0" />
        )}
      </button>
