...
- **`costMiddleware`** ([server/src/cost/middleware.ts](../../packages/server/src/cost/middleware.ts)) is the single choke-point; see [cost-optimization.md](./cost-optimization.md).
...
- [cost-optimization.md](./cost-optimization.md) — the cost layers (L0–L4).
